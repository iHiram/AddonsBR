    ...
    if (entityhit != undefined) {
        ...
        if (source.hasTag('ef-attract')) {
            ...
            if (irand <= iSoCommun) {
                ...
                entityhit.entity.applyKnockback((disX / 1.5), (disZ / 1.5), random(1, 10), 0)
            }
        }
...
function addEffects(entity) {
    ...
    if (listMobsRegular.includes(entity.typeId)) {
        ...
        entity.addEffect("speed", Infinity, { "amplifier": { "amplifier": random(1, 2), showParticles: true }, showParticles: true });
        if (irand <= tProbMobsRegular) {
            ...
            irand = random(1, tProb);
            if (irand <= iSoRare) {
                entity.addEffect("absorption", Infinity, { "amplifier": random(1, 2), showParticles: true });
            }
            irand = random(1, tProb);
            if (irand <= iCommun) {
                entity.addEffect("strength", Infinity, { "amplifier": random(1, 2), showParticles: true });
            }
            irand = random(1, tProb);
            if (irand <= iSoRare) {
                entity.addEffect("resistance", Infinity, { "amplifier": random(1, 2), showParticles: true });
            }
            irand = random(1, tProb);
            if (irand <= iLegent) {
                entity.addEffect("regeneration", Infinity, { "amplifier": random(1, 4), showParticles: true });
            }
            irand = random(1, tProb);
            if (irand <= iRare) {
        ...
        if (irand <= tProbMobsExceptions) {
            ...
            irand = random(1, tProb);
            if (irand <= iSoRare) {
                entity.addEffect("regeneration", Infinity, { "amplifier": random(1, 2), showParticles: true });
            }
            irand = random(1, tProb);
            if (irand <= iLegent) {
                entity.addEffect("invisibility", Infinity, 20);
...
function runEffect(entityHit, sourceEntity) {
    ...
    if (sourceEntity.hasTag('ef-weakness')) {
        entityHit.addEffect("weakness", random(50, 200), { "amplifier": random(1, 2), showParticles: true });
    }
    if (sourceEntity.hasTag('ef-slowness')) {
        entityHit.addEffect("slowness", random(50, 200), { "amplifier": random(1, 2), showParticles: true });
    }
    ...
    if (sourceEntity.hasTag('ef-hunger')) {
        entityHit.addEffect("hunger", random(50, 200), { "amplifier": random(1, 3), showParticles: true });
    }
